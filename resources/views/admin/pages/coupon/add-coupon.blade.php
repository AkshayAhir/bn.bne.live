    ...
    <section class="event_detail_sec bookings_list_sec" style="padding: 40px 0;">
        <div class="container">
            <div class="bookig_top_heaer">
                <h4 class="bookig_top_heaer_title">Add New Event Coupon</h4>
            </div>
            <div class="add_event_table">
                <form id="add-event-coupon" class="register_form">
                    ...
                    <div class="form-group  col-md-12 trending_formgroup">
                        ...
                        <input class="type form-control search_box" id="search"  type="text" placeholder="Enter event name">
                        <input type="hidden" name="event_id" id="event_id">
                    </div>
                    <div class="col-md-12 mb-3">
                        <div class="form_group">
                            <label for="coupon_code">Coupon code</label>
                            <input type="text" class="form-control form_field_input" id="coupon_code" name="coupon_code" placeholder="Enter coupon code" autocomplete="off">
                        </div>
                    </div>
                    <div class="col-md-12 mb-3">
                        <label for="coupon_code">Coupon discount</label>
                        <div class="form_group input-group">
                            <input type="number" class="form-control" name="coupon_discount" id="coupon_discount" placeholder="Enter Discount">
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="form-group ">
                            ...
                            <input type="number" class="form-control" name="no_of_coupon" id="no_of_coupon" placeholder="Enter number of coupon" value="">
                        </div>
                    </div>
                    <div class="col-md-12 mb-3">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="1" name="apply_discount" id="apply_discount" >
        ...
        $('#add-event-coupon').on('submit',function(event){
            ...
            if (fieldValidation()) {
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    url: "{{ url('admin/add_event_coupon') }}",
                    data: formData,
                    processData: false,
                    contentType: false,
                    success: function(response) {
                        ...
                        if (response['status'] == 1) {
                            ...
                            $("#status").html(
                                '<div class="alert alert-success"><strong>Success!</strong> New Event Coupon Added Successfully.</div>'
                            );
                            setTimeout(function () {
