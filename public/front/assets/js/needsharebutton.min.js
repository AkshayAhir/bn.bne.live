    ...
    window.needShareDropdown = function (a, b) {
        ...
        d.elem = a, d.elem.className += d.elem.className.length ? " need-share-button" : "need-share-button", d.getTitle = function () {
            ...
            mailto: function () {
                ...
                var a = d.options.protocol + "twitter.com/share?text=";
            ...
            var b = 500, c = 400, d = void 0 != window.screenLeft ? window.screenLeft : screen.left,
        ...
        for (var f in d.elem.dataset) if (f.match(/share/)) {
            var g = f.replace(/share/, "");
            if (!g.length) continue;
            g = g.charAt(0).toLowerCase() + g.slice(1), d.options[g] = d.elem.dataset[f]
        }
        if (d.options.networks = d.options.networks.toLowerCase().split(","), d.options.shareButtonClass) for (var e = 0; e < d.elem.children.length; e++) d.elem.children[e].className.match(d.options.shareButtonClass) && (d.button = d.elem.children[e]);
